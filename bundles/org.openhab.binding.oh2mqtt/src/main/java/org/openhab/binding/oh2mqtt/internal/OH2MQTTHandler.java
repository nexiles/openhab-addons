 ...
 */
@NonNullByDefault
public class OH2MQTTHandler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(OH2MQTTHandler.class);

    private @Nullable OH2MQTTConfiguration config;

    public OH2MQTTHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        config = getConfigAs(OH2MQTTConfiguration.class);
